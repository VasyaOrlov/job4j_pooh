...
/**
 * Class PoohServer - запускает сервер
 * Отправитель посылает запрос на добавление данных с указанием режима очереди и значением параметра
 * На основании указанного режима данные обрабатываются по сценарию данного режима
 */
public class PoohServer {
    /**
     * modes - карта с режимами
     */
